...
def gather_the_ids_of_all_bulletins_in_the_list() -> list[BulletinAuction]:
    ...
    bulletin_id_list: list[BulletinAuction] = []
    ...
    for result in results_to_process:
        ...
        bulletin_id_list.append(BulletinAuction(
...
def extracts_the_document_from_all_bulletins(
    bulletin_id_list: list[BulletinAuction],
) -> list[BulletinAuction]:
    ...
    for bulletin_id in bulletin_id_list:
        ...
        bulletin_id.BulletinDocument = page.inner_html("#document")
...
def pair_auctions_with_reference(auction_list: list[str]) -> list[Auction]:
...
def extracts_the_auctions_from_all_documents(
    bulletin_document_list: list[BulletinAuction],
) -> list[BulletinAuction]:
    ...
    for bulletin_document in bulletin_document_list:
        ...
        bulletin_document.BulletinAuctions = referenced_auction_paragraphs

    return bulletin_document_list

def write_the_bulletin_auctions_in_a_json_file(bulletin_auction_list: list[BulletinAuction]):
